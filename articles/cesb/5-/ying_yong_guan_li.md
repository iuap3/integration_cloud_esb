...
主要包括以下功能：应用仓库、应用发布、简单对照、规则对照、任务管理、数据源管理、连接配置。
...
连接配置主要是对连接器信息的配置，包括连接类型、连接名称、项目名称。

### 2.2.7.2 界面说明

单击【应用管理】→【连接配置】，进入连接配置页面。
