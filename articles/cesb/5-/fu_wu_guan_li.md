...
服务管理是指存储IDE发布到数据库中的服务及实体，包括系统管理、服务提供、调用关系维护、服务统计、服务仓库、实体管理。
...
单击〖注册〗按钮，填写应用系统的基本信息（*为必输项），包括系统名称、系统类型、主机名称、appkey、是否启用、IP、负责人邮箱、应用系统描述，单击〖确定〗，完成应用系统注册操作。

![](/assets/5-/3/image94.png)
